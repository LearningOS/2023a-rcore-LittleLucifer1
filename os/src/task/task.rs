...
pub struct TaskControlBlockInner {
    ...
    pub task_syscall_time: [usize; MAX_SYSCALL_NUM],
        ...
        let task_control_block = Arc::new(TaskControlBlock {
            ...
            inner: unsafe {
                UPSafeCell::new(TaskControlBlockInner {
                    ...
                    task_first_run:parent_inner.task_first_run,
                    task_first_time: parent_inner.task_first_time,
                    task_syscall_time: parent_inner.task_syscall_time.clone(),
                    task_priority: 16,
                    task_stride: 0,
                })
            },
